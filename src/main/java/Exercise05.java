...
public class Exercise05 {
    ...
    void question05() {
        ...
        if (menu == 1) {
            ...
            position.name = PositionName.SCUM_MASTER;
        } else {
    ...
    void question09() {
        ...
        accountA.id = 1;
        accountA.email = "beautifulufe@gmail.com";
        accountA.username = "beautifulufe";
        accountA.fullName = "Đinh Uyên";
        accountA.createdDate = LocalDate.now();

        Account accountB = new Account();
        accountB.id = 2;
        accountB.email = "uyenthitnuong@gmail.com";
        accountB.username = "uyenthitnuog";
        accountB.fullName = "Đinh Thị Thảo Uyên";
        accountB.createdDate = LocalDate.now();

        Account accountC = new Account();
        accountC.id = 3;
        accountC.email = "crabcrab0102@gmail.com";
        accountC.username = "crabcrab";
        accountC.fullName = "Uyên Đinh";
