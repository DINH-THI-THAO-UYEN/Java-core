...
public class QLTV {
    ...
    private List<Sach> taiLieuList = new ArrayList<Sach>();
    ...
    public void themTaiLieu() {
        ...
        switch (menu) {
            case 1:
                ...
                Sach book = new Sach(maTaiLieu, tenNhaXuatBan, soBanPhatHanh, tenTacGia, soTrang);
            ...
            case 2:
                ...
                TaiLieu magazine = new TaiLieu(maTaiLieu, tenNhaXuatBan, soBanPhatHanh, soPhatHanh, thangPhatHanh);
                taiLieuList.add(magazine);
                break;
            case 3:
                System.out.println("Nhập vào ngày phát hành: ");
                int ngayPhatHanh = scanner.nextInt();
                Bao newsPaper = new Bao(maTaiLieu, tenNhaXuatBan, soBanPhatHanh, ngayPhatHanh);
